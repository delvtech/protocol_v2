...
library FixedPointMath {
    ...
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a + b;
        if (c < a) revert ElementError.FixedPointMath__Add_Overflow();
        return c;
    }
    ...
    function sub(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        if (b > a) revert ElementError.FixedPointMath__Sub_Overflow();
        uint256 c = a - b;
        return c;
    }
    ...
    function exp(int256 x) internal pure returns (int256 r) {
        unchecked {
            ...
            if (x >= 135305999368893231589)
                revert ElementError.FixedPointMath__Exp_InvalidExponent();
    ...
    function ln(int256 x) internal pure returns (int256) {
        if (x <= 0)
            revert ElementError.FixedPointMath__Ln_NegativeOrZeroInput();
        return _ln(x);
    }
    ...
    function _ln(int256 x) private pure returns (int256 r) {
        unchecked {
            ...
            if (x < 0) revert ElementError.FixedPointMath__Ln_NegativeInput();
